...
- **Not started:** Phase 6 (editor/filepicker boxes), post-detail/comment view redesign (not originally numbered — needs its own pass per the Phase 4 gap), Phase 7 (polish pass + manual test sweep).
