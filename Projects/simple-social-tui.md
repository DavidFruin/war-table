...
- **Not started:** post-detail/comment view redesign (not originally numbered — needs its own pass per the Phase 4 gap), Phase 7 (polish pass + manual test sweep against a real feed — nothing since Phase 1's login screen has been visually confirmed live; this whole redesign still needs Dave's own eyes on it).
